...
import MobileConversationLists from './MobileConversationLists'

const MobileConversationScreen = ({setCurrentScreenTab}) => {
  return (
    <>
    <div className="h-screen w-screen flex flex-col relativ bg-white">
        <div className="header flex items-center justify-between px-5 h-[12%] fixe w-full bg-white">
          <h1 className="text-green-600 text-xl font-medium">WhatsApp</h1>
          <div className="flex justify-between items-center gap-4">
            <button className=" text-xl px-2 py-2">
              <MdQrCodeScanner />
            </button>
            <button className=" text-xl px-2 py-2">
              <FiCamera />
            </button>
            <button className="text-xl px-2 py-2" onClick={()=>setCurrentScreenTab(2)}>
              <BsThreeDotsVertical />
            </button>
          </div>
        </div>

        <div className="conversation h-[76%]">
          <ul className=" h-full overflow-scroll">
            <li className="px-3 py-2">
              <form action="" className="w-full">
                <div className="flex bg-secondary-gray justify-center items-center rounded-full">
                  <button className="px-4 py-3 text-2xl">
                    <IoMdSearch />
                  </button>
                  <input
                    type="text"
                    className="bg-transparent flex-grow h-full py-3 px-2 outline-none"
                    placeholder="Search"
                  />
                </div>

                <div className="flex gap-2 mt-4 mb-2">
                  <div className=" bg-secondary-green text-slate-700 hover:bg-secondary-gray px-4 py-[6px] text-[15px] rounded-full">
                    <input
                      type="checkbox"
                      className="hidden"
                  ...
                  <div className=" bg-gray-200 text-slate-700 hover:bg-secondary-gray px-4 py-[6px] text-[15px] rounded-full">
                    <input
                      type="checkbox"
                      className="hidden"
            ...
            <MobileConversationLists setCurrentScreenTab={setCurrentScreenTab} />
          </ul>
        </div>

        <div className="floating-add-conversation fixed right-4 bottom-24 ">
          <button className="p-4 bg-[#1dab61] rounded-xl text-[#1dab61]" onClick={()=>setCurrentScreenTab(3)}>
            <svg
              viewBox="0 0 24 24"
              height="24"
              width="24"
            ...
            >
              <path
                d="M.944 5.526 3 8.848v8.485A2.667 2.667 0 0 0 5.667 20h13.666A2.667 2.667 0 0 0 22 17.333V6.667A2.667 2.667 0 0 0 19.333 4H1.795a1 1 0 0 0-.85 1.526M5 8.28v9.053c0 .369.298.667.667.667h13.666a.667.667 0 0 0 .667-.667V6.667A.667.667 0 0 0 19.333 6H3.59z"
                fill="#fff"
              />
              <path
                d="M9.533 12.991h1.976v1.976c0 .433.254.85.667.982a.994.994 0 0 0 1.315-.94v-2.018h1.976c.433 0 .851-.255.982-.668a.994.994 0 0 0-.94-1.314H13.49V9.033c0-.433-.255-.85-.668-.982a.995.995 0 0 0-1.314.94v2.018H9.49a.994.994 0 0 0-.94 1.314c.13.413.548.668.982.668"
                fill="currentColor"
              />
              <path d="M9.533 12.991h1.976v1.976c0 .433.254.85.667.982a.994.994 0 0 0 1.315-.94v-2.018h1.976c.433 0 .851-.255.982-.668a.994.994 0 0 0-.94-1.314H13.49V9.033c0-.433-.255-.85-.668-.982a.995.995 0 0 0-1.314.94v2.018H9.49a.994.994 0 0 0-.94 1.314c.13.413.548.668.982.668" />
            </svg>
          </button>
        </div>

        <div className="footer flex w-full h-[12%] fixe bottom-0 items-center justify-between px-3 pb-5 pt-2 bg-white">
          <button className=" flex flex-col items-center justify-center text-sm">
            <div className="bg-secondary-green text-green-700 px-4 py-1 rounded-full ">
              <svg
                viewBox="0 0 24 24"
                height="24"
                width="24"
          ...
          <button className=" flex flex-col items-center justify-center text-sm">
            <div className=" px-4 py-1 rounded-full text-2xl">
              <MdOutlineLocalPhone />
            </div>
            Communities
          </button>
